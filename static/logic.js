...
function displayCounties() {
    ...
    html += '<div class="col-md-1"> <a href="' + response[0].CountyWikiLink + '">' + response[0].CountyName  +' </div>';
    html += '</div>';
    ...
    html += '<div class="col-md-1"> <a href="' + response[1].CountyWikiLink + '">' + response[1].CountyName  +' </div>';
    html += '</div>';
    ...
    html += '<div class="col-md-1"> <a href="' + response[2].CountyWikiLink + '">' + response[2].CountyName  +' </div>';
    html += '</div>';
